  ...
  head: () => ({
    meta: [
      ...
      { title: "BYAWA — Marketplace multi-vendeurs" },
      {
        name: "description",
        content:
          "BYAWA, la marketplace généraliste : mode, électronique, maison, alimentation. Vendeurs vérifiés et livraison partout au Sénégal.",
      },
      { name: "author", content: "BYAWA" },
      { property: "og:title", content: "BYAWA — Marketplace multi-vendeurs" },
      {
