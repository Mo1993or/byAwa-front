...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bc1Q6SIa.mjs");
...
var manifest = {
	"7f92d135aa3763ddd5bf6d4d9f84832b6b591cbaa35dcc4048b4b1beed8e7bf3": {
		...
		importer: () => import("./orders.functions-Cn9fy-Wj.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CinPgn2I.mjs").then((n) => n.t),
		import("./start-BVDBXGOZ.mjs"),
...
//#endregion
export { TSS_SERVER_FUNCTION as a, createServerFn as i, createCsrfMiddleware as n, getServerFnById as o, createMiddleware as r, getRequestHeader as s, server_exports as t };
